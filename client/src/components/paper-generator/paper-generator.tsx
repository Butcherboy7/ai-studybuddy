...
${generatedPaper.questions?.map((question: any, index: number) => `
Question ${index + 1}: (${question.points} points)
${question.question}

${question.options ? question.options.map((option: string, optIndex: number) => 
  `${String.fromCharCode(65 + optIndex)}. ${option}`).join('\n') : ''}

${'_'.repeat(50)}
`).join('\n')}

End of Practice Paper
Generated by EduTutor AI
    `.trim();
    ...
    link.href = url;
    link.download = `${config.subject}_${config.topic}_Practice_Paper.txt`;
    ...
    toast({
      ...
      description: "Practice paper downloaded successfully!"
    });
  };
