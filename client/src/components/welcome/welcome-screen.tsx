    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="bg-white border-b border-slate-200 px-8 py-6">
        <div className="max-w-3xl">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Welcome to EduTutor</h1>
          <p className="text-lg text-slate-600">Choose your AI tutor and start learning with personalized guidance</p>
        </div>
      </div>
      ...
      <div className="flex-1 px-8 py-8 overflow-y-auto">
        <div className="max-w-4xl">
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Select Your Tutor Persona</h2>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <button
                ...
                className="flex items-center p-4 border border-slate-200 rounded-lg hover:bg-slate-50 transition-all duration-200"
              >
                <i className="fas fa-file-contract mr-3 text-slate-600"></i>
                <div className="text-left">
                  <div className="font-medium text-slate-900">Generate Practice</div>
